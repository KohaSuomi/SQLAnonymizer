...
sub getConfig {
  ...
  my $confFile;
  my @confFileTries;
  push (@confFileTries, $ENV{SQLAnonCONF}) if $ENV{SQLAnonCONF};
  push (@confFileTries, getcwd().'/config/SQLAnon.conf', getcwd().'/../config/SQLAnon.conf', '/etc/SQLAnon/SQLAnon.conf');
